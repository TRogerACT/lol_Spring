		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-sm-6">
							<h2><b>IMAGEN CAMPEONES REGISTAR</b></h2>
						</div>
						<div class="col-sm-6">
							
							<button class="btn btn-success" type="button"
								onclick="location.href='<c:url value="/imagen_campeones_listar"/>'">CANCELAR</button>
					
						</div>
					</div>
				</div>
				<table class="table table-striped table-hover">
		       		<form:form name="" id="files" method="post" action="/lol/imagen_campeones_registrar" enctype="multipart/form-data">
		       				<br>
		       				<div align="center">
