	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2><b>IMAGEN CAMPEONES LISTAR</b></h2>
					</div>
					<div class="col-sm-6">
						<a class="btn btn-success" href="<c:url value='/imagen_campeones_registrar'/>">REGISTRAR</a>
			...
			<table class="table table-striped table-hover">
				...
				<c:forEach var="imagencampeones" items="${bImagenc}">
				<tr>
					<td><font>${imagencampeones.imagenId}</font></td>
					<td><font>${imagencampeones.nombre}</font></td>
					<td>				
						<c:set var="typeImage" value="${fn:substringAfter(imagencampeones.nombre,'.')}"/>
						<img src="data:image/${typeImage};base64,${imagencampeones.getBase64Imagencampeones()}" 
					...
					<td></td>																		
					<td>
						<a href="<c:url value="/imagen_campeones_editar/${imagencampeones.imagenId}"/>">EDITAR</a>
						<a href="<c:url value="/imagen_campeones_borrar/${imagencampeones.imagenId}"/>">BORRAR</a>
