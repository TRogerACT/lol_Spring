	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2><b>IMAGEN LISTAR</b></h2>
					</div>
					<div class="col-sm-6">
						<a class="btn btn-success" href="<c:url value='/imagen_registrar'/>">REGISTRAR</a>
			...
			<table class="table table-striped table-hover">
				...
				<tr>
					<td><font>${imagen.imagenId}</font></td>
					<td><font>${imagen.nombre}</font></td>
					<td>				
						<c:set var="typeImage" value="${fn:substringAfter(imagen.nombre,'.')}"/>
						<img src="data:image/${typeImage};base64,${imagen.getBase64Imagen()}" 
					...
					<td></td>																		
					<td>
						<a href="<c:url value="/imagen_editar/${imagen.imagenId}"/>">EDITAR</a>
						<a href="<c:url value="/imagen_borrar/${imagen.imagenId}"/>">BORRAR</a>
