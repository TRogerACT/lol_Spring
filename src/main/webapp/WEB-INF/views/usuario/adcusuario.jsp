	...
	<div class="card mb-3" style="max-width: 540px;">
	  <div class="row g-0">
	    <div class="col-md-4">
					...
					<img class="img-fluid rounded-start" src="data:image/${typeImage};base64,${roladc.imagencampeones.getBase64Imagencampeones()}" 
					/>
	    </div>
	    <div class="col-md-8">
	      <div class="card-body">
	        <h5 class="card-title">${roladc.nombre}</h5>
	        <p class="card-text">${roladc.descripcion}</p>
	        <p class="card-text"><small class="text-muted">ADC</small></p>
	      </div>
	    </div>
	  </div>
	</div>
