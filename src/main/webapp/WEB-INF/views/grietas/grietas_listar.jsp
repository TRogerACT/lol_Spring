...
<html>
	...
	<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
			...
			<link rel="stylesheet" 
              href="<c:url value="/resources/css/GrietasFondo.css"/>">                 
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-sm-6">
							<h2><b>GRIETAS LISTAR</b></h2>
						</div>
						<div class="col-sm-6">
							<a class="btn btn-success" href="<c:url value='/grietas_registrar'/>">REGISTRAR</a>
				...
				<table class="table table-striped table-hover">
					...
					<c:forEach var="grietas" items="${bGrietas}">
					<tr>
						<td><font>${grietas.grietasId}</font></td>
						<td><font>${grietas.nombre}</font></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
						...
						<td></td>																		
						<td>
							<a  href="<c:url value="/grietas_editar/${grietas.grietasId}"/>">EDITAR</a>
							<a  href="<c:url value="/grietas_borrar/${grietas.grietasId}"/>">BORRAR</a>
						</td>
					</tr>
