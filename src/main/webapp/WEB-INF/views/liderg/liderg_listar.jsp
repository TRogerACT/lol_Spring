	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2><b>LIDERES LISTAR</b></h2>
					</div>
					<div class="col-sm-6">
						<a class="btn btn-success" href="<c:url value='/liderg_registrar'/>">REGISTRAR</a>
			...
			<table class="table table-striped table-hover">
				...
				<c:forEach var="liderg" items="${bLiderg}">
				<tr>
					<td><font>${liderg.lidergId}</font></td>
					<td><font>${liderg.nombre}</font></td>
					<td></td>
					<td></td>
					<td></td>		
					<td></td>
					...
					<td></td>																		
					<td>
						<a href="<c:url value="/liderg_editar/${liderg.lidergId}"/>">EDITAR</a>
						<a href="<c:url value="/liderg_borrar/${liderg.lidergId}"/>">BORRAR</a>
